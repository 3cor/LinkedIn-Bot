...
run_non_stop = True                 # True or False, Note: True or False are case-sensitive - CONTINUOUS MODE: Enabled
'''
Note: Will be treated as False if `run_in_background = True`
'''
alternate_sortby = False            # True or False, Note: True or False are case-sensitive - SAFE MODE: Disabled
cycle_date_posted = False           # True or False, Note: True or False are case-sensitive - SAFE MODE: Disabled
...
# >>>>>>>>>>> MongoDB Settings <<<<<<<<<<<
# Set use_mongodb = True to store all job data in MongoDB instead of CSV files.
# Set use_mongodb = False to keep the original CSV-based storage (no MongoDB required).
use_mongodb = True                              # True or False
mongodb_uri = "mongodb://localhost:27017"       # MongoDB connection URI (update for Atlas: "mongodb+srv://...")
mongodb_database = "linkedin"              # Database name (will be created automatically)

# Set the maximum amount of time allowed to wait between each click in secs
click_gap = 4                       # Enter max allowed secs to wait approximately. (Only Non Negative Integers Eg: 0,1,2,3,....) - SAFE MODE: Set to 4
...
smooth_scroll = True                # True or False, Note: True or False are case-sensitive - SAFE MODE: Enabled
...
stealth_mode = False               # True or False, Note: True or False are case-sensitive - TEMPORARILY DISABLED due to Chrome/ChromeDriver version mismatch
